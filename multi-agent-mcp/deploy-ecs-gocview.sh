...
keys = {
    ...
    "PAGERDUTY_API_TOKEN", "PAGERDUTY_SHIFT1_USER_IDS", "PAGERDUTY_SHIFT2_USER_IDS", "PAGERDUTY_SHIFT3_USER_IDS",
    "PAGERDUTY_TEAM_USER_IDS", "PAGERDUTY_SHIFT1_LABEL", "PAGERDUTY_SHIFT2_LABEL", "PAGERDUTY_SHIFT3_LABEL",
    "PAGERDUTY_INCIDENTS_LOOKBACK_DAYS", "SHIFT1_OUTLOOK_NOC_MEMBERS", "SHIFT2_OUTLOOK_NOC_MEMBERS", "SHIFT3_OUTLOOK_NOC_MEMBERS", "SLACK_BOT_TOKEN", "SLACK_WEBHOOK_URL", "ATLASSIAN_EMAIL",
    "ADT_STATUS_DASHBOARD_ID", "SAMSUNG_STATUS_DASHBOARD_ID", "CAT_STATUS_DASHBOARD_ID", "COMCAST_STATUS_DASHBOARD_ID",
    "SAMSUNG_DD_ENV", "CAT_DD_ENV", "COMCAST_DD_ENV",
    ...
    "GEMINI_API_KEY", "ANTHROPIC_API_KEY", "SNOW_USER", "SNOW_PASSWORD",
    "SNOW_SESSION_COOKIE", "SNOW_USER_TOKEN", "SNOW_INSTANCE", "ADMIN_TOKEN",
    ...
    "TABLEAU_SERVER_URL", "TABLEAU_SITE_CONTENT_URL", "TABLEAU_PAT_NAME", "TABLEAU_PAT_SECRET", "TABLEAU_PROBE_URL",
    "FIREBASE_PROJECT_ID", "FIREBASE_IOS_APP_ID", "FIREBASE_IOS_BUNDLE_ID", "FIREBASE_GCM_SENDER_ID",
    "FIREBASE_GA4_PROPERTY_ID_IOS", "FIREBASE_GA4_PROPERTY_ID_ANDROID",
    "FIREBASE_GA4_SERVICE_ACCOUNT_PATH_IOS", "FIREBASE_GA4_SERVICE_ACCOUNT_PATH_ANDROID",
    "FIREBASE_GOOGLE_SERVICES_JSON", "FIREBASE_GOOGLE_SERVICE_INFO_PLIST", "FIREBASE_PROBE_URL",
    "SHM_VIEW_API_BASE", "SHM_DAILY_API_BASE",
    "SPLUNK_BEARER_TOKEN", "SPLUNK_REST_PORT", "SPLUNK_SEARCH_TIMEOUT", "SPLUNK_RESULTS_COUNT",
    "SPLUNK_FORCE_IPV4", "SPLUNK_CALENDAR_TIMEZONE", "SPLUNK_NS_OWNER",
    "SPLUNK_ACTIVE_USER_APP", "SPLUNK_ACTIVE_USER_BY_OS_SPL", "SPLUNK_MAU_APP", "SPLUNK_HARLEM_APP",
    "SPLUNK_ONBOARDING_APP",
}
out = {
    "ADMIN_TOKEN": "ONEVIEW",
...
aws ecs describe-task-definition --region "$AWS_REGION" --task-definition "$TASK_FAMILY" \
  ...
  'def drop: ["GUNICORN_TIMEOUT","AWS_ACCESS_KEY_ID","AWS_SECRET_ACCESS_KEY","AWS_SESSION_TOKEN","AWS_REGION",
    ...
    "SPLUNK_AUTH_MODE","PAGERDUTY_API_TOKEN","PAGERDUTY_SHIFT1_USER_IDS","PAGERDUTY_SHIFT2_USER_IDS","PAGERDUTY_SHIFT3_USER_IDS",
    "PAGERDUTY_TEAM_USER_IDS","PAGERDUTY_SHIFT1_LABEL","PAGERDUTY_SHIFT2_LABEL","PAGERDUTY_SHIFT3_LABEL","PAGERDUTY_INCIDENTS_LOOKBACK_DAYS",
    "ADT_STATUS_DASHBOARD_ID","SAMSUNG_STATUS_DASHBOARD_ID","CAT_STATUS_DASHBOARD_ID","COMCAST_STATUS_DASHBOARD_ID",
    "SAMSUNG_DD_ENV","CAT_DD_ENV","COMCAST_DD_ENV",
    "DD_CAT_DASHBOARD_ID","DD_COMCAST_DASHBOARD_ID","DATADOG_CAT_DASHBOARD_ID","DATADOG_COMCAST_DASHBOARD_ID",
