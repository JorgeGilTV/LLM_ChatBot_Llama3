...
LEGACY_TO_MCP_CHECKBOX: dict[str, str] = {
    ...
    "DD_Red_CAT": mcp_checkbox_value("datadog_red_cat"),
    "DD_Red_Comcast": mcp_checkbox_value("datadog_red_comcast"),
    ...
    "DD_CAT_Errors": mcp_checkbox_value("datadog_cat_errors"),
    "DD_Comcast_Errors": mcp_checkbox_value("datadog_comcast_errors"),
