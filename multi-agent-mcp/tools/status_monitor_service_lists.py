...
# Extra APM service names (Software Catalog treemap / org UI) merged into the catalog wall fallback only.
SOFTWARE_CATALOG_TREEMAP_EXTRAS = [
    ...
    "collector",
    "backend-hmsfwa",
    "backend-hmslostreamingserver",
    "backend-mediamigrationscheduler",
    "backend-hmsautomation-on",
    "backend-arlosafeadmin",
